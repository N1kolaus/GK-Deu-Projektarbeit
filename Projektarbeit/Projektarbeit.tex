...
Mit dem Öffnen eines Terminal-Fensters im Ordner der API und mittels \texttt{docker-compose up} wird Anwendung gestartet. Der Docker-Container läuft ab jetzt im Hintergrund und wartet auf Speicher- oder Abrufbefehle. Ob die Auswirkungen richtig funktioniert kann mittels
