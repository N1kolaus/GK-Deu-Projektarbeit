...
\chapter{Entstehung von CO$_2$ und dessen Auswirkungen auf den Menschen}
...
Die zentrale Stelle, an der Daten eingehen und gespeichert sowie abgerufen werden können, wird mittels der CO2MonitorAPI realisiert. Hier kann in der docker-compose-Datei der Port bestimmt werden, auf dem das \ac{API} erreichbar ist.
