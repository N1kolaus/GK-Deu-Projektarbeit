...
Ist der USB-Port bestimmt, kann der vordere Teil der devices, also \enquote{\texttt{/dev/hidraw0}} mit dem ausgelesenen Port ersetzt werden, zu sehen in \vref{code:compose:hidraw}.
