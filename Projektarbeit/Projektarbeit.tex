...
{
  name=API,
  description={ist der englische Fachbegriff für eine Programmierschnittstelle, oder auch Anwendungsschnittstelle.
...
Für die Verwendung der Programme rund um den CO$_2$-Monitor wird folgende Hardware verwendet:
