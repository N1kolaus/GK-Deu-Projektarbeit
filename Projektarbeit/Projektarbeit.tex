...
Hinweis: Wird dieser geändert, müssen im \textit{Reader} und im Frontend der Port der API ebenfalls angepasst werden.

Mit dem Öffnen eines Terminal-Fensters im Ordner der API und mittels \texttt{docker-compose up} wird die Anwendung gestartet. Der Docker-Container läuft ab jetzt im Hintergrund und wartet auf Speicher- oder Abrufbefehle. Ob die Applikation richtig funktioniert kann mittels
